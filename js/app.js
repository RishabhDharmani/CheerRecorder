...
function frameLooper(){
	...
	//adding each frame data to one single array
	dataArray.push([fbc_array]);
...
function stopRecording() {
	...
	//convert array of frequencies to JSON object
	jsonStoring = JSON.stringify(dataArray);

	//slides the visualizer up
	slideUp();

	//create the wav blob and pass it on to createDownloadLink
	//timeout to allow visualizer to close
	setTimeout(function(){rec.exportWAV(createDownloadLink)}, 700);
}

///////////// Create Upload Link and Display recorded Audio //////////////////////

function createDownloadLink(blob) {

	//To be added as a list
	...
	var filename = prompt('Enter a name for sound clip?', 'Recording');
	...
	upload.setAttribute("class", "save");
	upload.href="#";
